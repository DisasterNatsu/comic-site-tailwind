...
const Register = () => {
  ...
  return (
    <>
      <NextSeo
        title="Disaster Scans - Register"
        titleTemplate="Disaster Scans - Register"
        description="https://disasterscans.com's user registration page"
        canonical="https://disasterscans.com/register"
        openGraph={{
          url: "https://disasterscans.com/register",
          title: "Disaster Scans - Register",
          description: "disasterscans.com user registeration page",
          images: [
            {
