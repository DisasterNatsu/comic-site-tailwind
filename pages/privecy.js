  ...
  return (
    <>
      <NextSeo
        ...
        description="https://disasterscans.com's Privacy Policy decleration"
      ...
      <Layout>
        <div className="p-4 dark:text-white privecy">
          <h2 className="text-5xl font-semibold border-b-2 border-dotted border-dark dark:border-white mb-3 text-center">
          ...
          <section>
            <p className="md:text-left text-center">
              ...
              <Link
                className="cursor-pointer text-slate-400 hover:text-yellow-400"
                href="/home"
              >
                disasterscans.com
              </Link>
              ...
              collected and recorded by Disaster Scans and how we use it. If you
              ...
              and/or collect in Disaster Scans. This policy is not applicable to
          ...
          <section>
            ...
            <ul className="list-disc md:px-10 sm:px-5">
              <li className="my-2">
          ...
          <section>
            ...
            <p className="md:text-left text-center my-3">
              Like any other website, Disaster Scans uses &ldquo;cookies&ldquo;.
          ...
          <section>
            ...
            <p className="md:text-left text-center my-3">
              ...
              the advertising partners of Disaster Scans.
            </p>
            <p className="md:text-left text-center my-3">
