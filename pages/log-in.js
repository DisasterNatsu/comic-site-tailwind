...
const LogIn = () => {
  ...
  return (
    <>
      <NextSeo
        title="Disaster Scans - Log In"
        titleTemplate="Disaster Scans - Log In"
        description="https://disasterscans.com's user log in page"
        canonical="https://disasterscans.com/log-in"
        openGraph={{
          url: "https://disasterscans.com/log-in",
          title: "Disaster Scans - Log In",
          description: "disasterscans.com user log in page",
          images: [
            {
