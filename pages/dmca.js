  ...
  return (
    <>
      <NextSeo
        ...
        description="https://disasterscans.com's DMCA page"
        ...
        <div className="p-4 dark:text-white privecy">
          ...
          <section>
            <p className="md:text-left text-center mt-3">
              ...
              protect content creators from having their work stolen and
              published by other people on the internet.
            </p>
            <p className="md:text-left text-center mt-3">
          ...
          <section>
            ...
            <p className="md:text-left text-center my-3">
              Not with standing anything to the contrary contained in any
              portion of this Policy, the Operator reserves the right to take no
              action upon receipt of a DMCA copyright infringement notification
              if it fails to comply with all the requirements of the DMCA for
              such notifications.
            </p>
            <p className="md:text-left text-center my-3">
